const { statement, htmlStatement } = require("./finished");
const invoices = [
  {
    customer: "BigCo",
    performances: [
...
describe("Function: htmlStatement", () => {
  test("Should return correct string for BigCo", () => {
  ...
  test("Should return correct string for NewCo", () => {
    const expectedResult = `<h1>Statement for NewCo</h1>\n<table>\n<tr><th>play</th><th>seats</th><th>cost</th></tr> <tr><td>The Twelfth Night</td><td>200</td><td>$2,100.00</td></tr>\n <tr><td>MacBeth</td><td>100</td><td>$1,100.00</td></tr>\n</table>\n<p>Amount owed is <em>$3,200.00</em></p>\n<p>You earned <em>240</em> credits</p>\n`;
    const result = htmlStatement(invoices[1], plays);
    expect(result).toEqual(expectedResult);
  });
  test("Should return correct string for SmallCo", () => {
    const expectedResult = `<h1>Statement for SmallCo</h1>\n<table>\n<tr><th>play</th><th>seats</th><th>cost</th></tr> <tr><td>The Twelfth Night</td><td>10</td><td>$400.00</td></tr>\n <tr><td>MacBeth</td><td>5</td><td>$400.00</td></tr>\n <tr><td>As You Like It</td><td>2</td><td>$306.00</td></tr>\n <tr><td>Othello</td><td>12</td><td>$400.00</td></tr>\n <tr><td>As You Like It</td><td>1</td><td>$303.00</td></tr>\n</table>\n<p>Amount owed is <em>$1,809.00</em></p>\n<p>You earned <em>0</em> credits</p>\n`;
    const result = htmlStatement(invoices[2], plays);
    expect(result).toEqual(expectedResult);
  });
  test("Should throw error if play not found", () => {
    let result;
    try {
      htmlStatement(invoices[3], plays);
    } catch (err) {
      result = err;
    }
    expect(result.message).toBe("unknown type: error");
